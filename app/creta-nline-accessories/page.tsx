...
export default function CretaNLineAccessoriesPage() {
  ...
  const [selectedAccessory, setSelectedAccessory] = useState<typeof CRETA_NLINE_ACCESSORIES[0] | null>(null)
  ...
  const handleEnquire = (accessory: typeof CRETA_NLINE_ACCESSORIES[0]) => {
