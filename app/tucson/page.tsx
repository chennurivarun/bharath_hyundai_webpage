...
export const metadata: Metadata = {
  title: "Hyundai Tucson | Premium SUV | Price, Features, Specs | Bharath Hyundai",
  description: "Explore the Hyundai Tucson premium SUV. Starting at ₹27.31 Lakh. Advanced features, safety, performance, and luxury. Book a test drive at Bharath Hyundai.",
  keywords: ["Hyundai Tucson", "Tucson SUV", "Hyundai Tucson price", "Tucson specifications", "premium SUV", "Tucson features"],
  openGraph: {
    title: "Hyundai Tucson | Bharath Hyundai",
