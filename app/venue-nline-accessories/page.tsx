...
const VENUE_NLINE_ACCESSORIES = [
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 134,
    description: "Protective door side moulding for Venue N Line"
  },
  {
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 98,
    description: "Sporty paddle shift covers for N Line"
  },
  {
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 298,
    description: "Premium seat covers for Venue N Line SUV"
  },
  {
    id: "dash-cam",
    name: "DASH CAM",
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Genuine Venue N Line Accessories
            </h1>
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Enhance your sporty compact SUV with Genuine Hyundai Venue N Line Accessories that combine performance, style, and safety.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">Designed and tested specifically for Venue N Line to ensure perfect fit and performance.</p>
            </div>
            <div className="text-center">
              <div className="p-4 bg-red-600/20 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
