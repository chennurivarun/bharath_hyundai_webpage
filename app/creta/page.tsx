...
export const metadata: Metadata = {
  title: "Hyundai Creta | SUV | Price, Features, Specs | Bharat Hyundai",
  description: "Explore the Hyundai Creta SUV. Starting at ₹10.72 Lakh. Features, specifications, colors, variants, and more. Book a test drive at Bharat Hyundai.",
  keywords: ["Hyundai Creta", "Creta SUV", "Hyundai Creta price", "Creta specifications", "Creta features", "Creta variants", "SUV"],
  openGraph: {
    title: "Hyundai Creta | Bharat Hyundai",
