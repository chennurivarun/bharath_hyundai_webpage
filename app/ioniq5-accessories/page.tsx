...
const IONIQ5_ACCESSORIES = [
  {
    ...
    price: "₹5,357",
    originalPrice: "₹5,357",
    image: "/images/accessories/ioniq5/body-cover-premium.png",
    rating: 4.8,
    reviews: 189,
    description: "Premium waterproof body cover for IONIQ 5"
  },
  {
    ...
    price: "₹7,823",
    originalPrice: "₹7,823",
    image: "/images/accessories/ioniq5/carpet-mat-premium.png",
    rating: 4.9,
    reviews: 267,
  ...
  {
    id: "boot-mat-carpet",
    name: "BOOT MAT CARPET",
    category: "Interior",
    price: "₹6,505",
    originalPrice: "₹6,505",
    image: "/images/accessories/ioniq5/boot-mat-carpet.png",
    rating: 4.7,
    reviews: 234,
    description: "Premium boot mat carpet for cargo protection"
  },
  {
    ...
    price: "₹7,529",
    originalPrice: "₹7,529",
    image: "/images/accessories/ioniq5/front-trunk-liner.png",
    rating: 4.6,
    reviews: 156,
    description: "Premium front trunk liner for IONIQ 5"
  },
  {
    id: "dash-cam",
    name: "DASH CAM",
    ...
    image: "/images/accessories/ioniq5/dash-cam.png",
    rating: 4.8,
    reviews: 178,
    description: "HD dash camera with night vision and parking mode"
  },
]

const CATEGORIES = ["All", "Interior", "Exterior", "Electrical"]

export default function Ioniq5AccessoriesPage() {
  const [searchQuery, setSearchQuery] = useState("")
  const [selectedCategory, setSelectedCategory] = useState("All")
  const [selectedAccessory, setSelectedAccessory] = useState<typeof IONIQ5_ACCESSORIES[0] | null>(null)
  const [isModalOpen, setIsModalOpen] = useState(false)
  
  const filteredAccessories = IONIQ5_ACCESSORIES.filter((accessory) => {
  ...
  const handleEnquire = (accessory: typeof IONIQ5_ACCESSORIES[0]) => {
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Genuine IONIQ 5 Accessories
            </h1>
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Enhance your electric SUV with accessories that combine style, comfort, and functionality.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">Designed and tested specifically for IONIQ 5 to ensure perfect fit and performance.</p>
            </div>
            <div className="text-center">
              <div className="p-4 bg-[#0057B8]/20 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
