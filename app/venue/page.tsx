...
export const metadata: Metadata = {
  title: "Hyundai Venue | Compact SUV | Price, Features, Specs | Bharath Hyundai",
  description: "Explore the Hyundai Venue compact SUV. Starting at ₹7.26 Lakh. Smart features, safety, and performance. Book a test drive at Bharath Hyundai.",
  keywords: ["Hyundai Venue", "Venue SUV", "compact SUV", "Hyundai Venue price", "Venue specifications", "Venue features"],
  openGraph: {
    title: "Hyundai Venue | Bharath Hyundai",
